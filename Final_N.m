function [ nothing ] = Final_N( NOX_real,NOX_real_P,Ex,Cv,Cs )
%       Gumbel参数评价
...
NOX_text = Real_Text_N (NOX_real,NOX_real_P,Ex(1),Cv(1));
...
NOX_text = Real_Text_N (NOX_real,NOX_real_P,Ex(2),Cv(2));
...
NOX_text = Real_Text_N (NOX_real,NOX_real_P,Ex(3),Cv(3));
...
NOX_text = Real_Text_N (NOX_real,NOX_real_P,Ex(4),Cv(4));
...
NOX_text = Real_Text_N (NOX_real,NOX_real_P,Ex(5),Cv(5));
