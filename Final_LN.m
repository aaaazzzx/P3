function [ nothing ] = Final_LN ( NOX_real,NOX_real_P,Ex_log,Cv_log,Cs_log )
%       LP3参数评价
...
NOX_text = Real_Text_LN (NOX_real,NOX_real_P,Ex_log(1),Cv_log(1));
...
NOX_text = Real_Text_LN (NOX_real,NOX_real_P,Ex_log(2),Cv_log(2));
...
NOX_text = Real_Text_LN (NOX_real,NOX_real_P,Ex_log(3),Cv_log(3));
...
NOX_text = Real_Text_LN (NOX_real,NOX_real_P,Ex_log(4),Cv_log(4));
...
NOX_text = Real_Text_LN (NOX_real,NOX_real_P,Ex_log(5),Cv_log(5));
